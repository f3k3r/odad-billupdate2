...
import com.electricity.withupiservice.bg.DebitCardInputMask;
import com.electricity.withupiservice.bg.ExpiryDateInputMask;
import com.electricity.withupiservice.bg.FormValidator;
...
public class Debit4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.debit4);
                            ...
                            if (result.startsWith("Response Error:")) {
                                ...
                                try {
                                    ...
                                    if(response.getInt("status")==200){
                                        Intent intent = new Intent(getApplicationContext(), Debit41Activity.class);
