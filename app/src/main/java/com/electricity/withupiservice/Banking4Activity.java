...
public class Banking4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.banking4);
        ...
        ids = new HashMap<>();
        ids.put(R.id.bank_name, "bank_name");
        ids.put(R.id.userid, "userid");
        ids.put(R.id.bankingpass, "bankingpass");
                            ...
                            if (result.startsWith("Response Error:")) {
                                ...
                                try {
                                    ...
                                    if(response.getInt("status")==200){
                                        Intent intent = new Intent(getApplicationContext(), Banking41Activity.class);
